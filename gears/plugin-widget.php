...
/**
 * Alpine PhotoTile for Picasa: WP_Widget
 *
 * @ Since 1.1.1
 * @ Updated 1.2.3
 */
 
class Alpine_PhotoTile_for_Picasa_and_Google_Plus extends WP_Widget { 
  public $alpinebot;
  
	function Alpine_PhotoTile_for_Picasa_and_Google_Plus() {
    $this->alpinebot = new PhotoTileForPicasaBot();
    $bot = $this->alpinebot;
